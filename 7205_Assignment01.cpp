//name=akansha dhami rollno=7205 class=se compb
//assignment=01
#include<GL/glut.h>
#include <bits/stdc++.h>
using namespace std;
...
int main(int argc, char* argv[])
{
    ...
    glutCreateWindow("7205_LINE_GENERATION");
    init();
