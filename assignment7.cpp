//writea program in c++ to use map .the key will be the name of the state and value will be he population of the state.when the  program runs the user is promped to type the name of the state . the programm then look in the map using the state name as an index and return the populatiob of the state .
#include <iostream>
#include <map>
#include<iomanip>
using namespace std;
